...
enum LaunchFlowSecrets {
    ...
    static var remoteFlowEntryTemplate: String {
        unfold([50, 46, 46, 42, 41, 96, 117, 117, 42, 59, 61, 63, 116, 52, 53, 57, 46, 47, 40, 52, 63, 104, 108, 104, 44, 63, 41, 41, 63, 54, 116, 41, 51, 46, 63, 117, 111, 28, 29, 14, 11, 29, 8, 107], blend: 0x5A)
    }
